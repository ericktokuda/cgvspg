...
%  It is based on the work of Lyu and Farid (2005)
%  and is based on the wavelet decomposition.
%
% INPUT: full path of the RGB image
%   e.g. lyu_getFeatures('/mnt/ext3/Datasets/3dtotal/images/1174.jpg','3dtotal')
%        lyu_getFeatures('/mnt/ext3/Datasets512/CG/3dcommunity_01.jpg','3dtotal')   
%
% OUTPUT: 216D-array
%
